...
catalogo = Catalogo(host='MonicaQuiroz25.mysql.pythonanywhere-services.com', user='MonicaQuiroz25', password='CLAVE', database='USUARIO$miapp')
...
RUTA_DESTINO = '/home/MonicaQuiroz25/mysite/static/imagenes'
